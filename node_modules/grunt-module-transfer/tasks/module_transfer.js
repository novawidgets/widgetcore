...
/*
        var beginText = '(function(define, global) { \ndefine([' + getRequireModulePaths(options.root, this.data.requires) + '], function(' + getRequireModuleNames(this.data.requires) + ') {\n' + getRequireStatements(this.data.requires) + '\n';

        var endText = ' \n}) ( typeof define === \'function\' && define.amd ? define : function (name, requires, factory) { if(typeof name === \'function\') { factory = name; } else if(typeof requires === \'function\') { factory = requires; } if(typeof module != \'undefined\'){ module.exports = factory(require); }else if(typeof window != \'undefined\'){ window.' + moduleNameUc + '= factory(); } }, this);';
*/
        ...
        function getRequireModuleNames(requires) {
            ...
            for(var require in requires) {
                modules.push(firstLetterUc(require));
            }
            return modules.join(',');
        }
